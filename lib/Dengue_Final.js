...
function updateSurface(){
	...
	images.transition()
	 ...
	 $('#stats_' + cnt).text(statistics[cnt].count.toFixed(2));
}
...
function setbiting(){
	...
	if ($('#set-biting-btn').hasClass('clicked-btn')) {
		return;
	}
	...
	$('#set-biting-btn').addClass('clicked-btn');
	redrawWindow();
}

function settrap(){

	if ($('#set-trap-btn').hasClass('clicked-btn')) {
		return;
	}
	...
	$('#set-trap-btn').addClass('clicked-btn');
	redrawWindow();
}

function setwater(){

	if ($('#set-water-btn').hasClass('clicked-btn')) {
		return;
	}
	...
	$('#set-water-btn').addClass('clicked-btn');
	redrawWindow();
}

function setspawn(){

	if ($('#set-spawn-btn').hasClass('clicked-btn')) {
		return;
	}
	...
	$('#set-spawn-btn').addClass('clicked-btn');
	redrawWindow();
}

function sethuman(){
	if ($('#set-human-btn').hasClass('clicked-btn')) {
		return;
	}
	...
	$('#set-human-btn').addClass('clicked-btn');
	redrawWindow();
}
