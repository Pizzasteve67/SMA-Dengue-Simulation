...
var srow=2
var nrow=Math.floor(maxCols/2)
var scol=2
var ncol=Math.floor(maxCols/2)

var areas =[
 {"label":"City","startRow":srow,"numRows":nrow,"startCol":scol,"numCols":ncol,"color":"#919191"},
 {"label":"Zone1","startRow":srow,"numRows": Math.floor(nrow/2)-1,"startCol":scol,"numCols": Math.floor(ncol/2)-1,"color":"#42884b"},
 {"label":"Zone2","startRow": srow ,"numRows": Math.floor(nrow/2)-1,"startCol":scol+Math.floor(ncol/2)+1,"numCols": Math.floor(ncol/2)-1,"color":"#42884b"},
 {"label":"Zone3","startRow": srow + Math.floor(nrow/2)+1.4,"numRows": Math.floor(nrow/2)-1,"startCol":scol,"numCols": Math.floor(ncol/2)-1,"color":"#42884b"},
 {"label":"Zone4","startRow": srow + Math.floor(nrow/2)+1.4,"numRows": Math.floor(nrow/2)-1,"startCol":scol+Math.floor(ncol/2)+1,"numCols": Math.floor(ncol/2)-1,"color":"#42884b"}	
]
...
//Create all possible combinations of building coordinates
  for (i = 0; i < rowBuildings.length; i++) {
	for (j = 0; j < colBuildings.length; j++){
		// we dont want buildings on the roads (3,3)
		if(i!=3 && j!=3){
...
// These variables define what is the probability of getting infected when a infected mosquito is near to a uninfected citizen 
