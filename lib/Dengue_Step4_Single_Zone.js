...
var statistics = [
	// citizen stats
	{"name":"Cumulative Total Dengue Cases: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
	{"name":"Current Active Dengue Cases: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
	{"name":"Max Active Dengue Cases: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
	// mosquito stats
	{"name":"Total Mosquito Population: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
	{"name":"Infected Mosquito Population: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
	{"name":"Max Infected Mosquitoes: ","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
  {"name":"Current Time","location":{"row":maxCols-3,"col":scol+ncol},"count":0},
    ];
...
console.log("rows buildings", rowBuildings)
...
console.log("rows of All", rowAll);
console.log("cols of All", colAll);
...
console.log("available all", allEmpty);
...
console.log("all traps are",allTrapsAvail);
console.log("all waters are",allWatersAvail);
...
function redrawWindow(){
	...
	// parameters
	humanDensity= document.getElementById("slider1a").value;
	BitingRate= document.getElementById("slider1b").value;
	trapDensity= document.getElementById("slider1c").value;
	TrapRate= document.getElementById("slider1d").value;
	waterDensity= document.getElementById("slider1e").value;
	SpawnRate = document.getElementById("slider1f").value;
...
function updateSurface(){
  ...
  // var allgraphs = surface.selectAll(".graphs").data(statistics);
	// var newgraphs = allgraphs.enter().append("g").attr("class","graphs");
	// // For each new area, append a rectangle to the group
	// newgraphs.append("div")
	// .attr("x", function(d){return (d.startCol-1)*cellWidth;})
	// .attr("y",  function(d){return (d.startRow-1)*cellHeight;})
	// .attr("width",  function(d){return d.numCols*cellWidth;})
	// .attr("height",  function(d){return d.numRows*cellWidth;})
  ...
  //
  // allgraphs.exit().remove()


	//Keenan stuck here lol
