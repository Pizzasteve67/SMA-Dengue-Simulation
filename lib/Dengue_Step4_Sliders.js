...
function redrawWindow(){
  ...
  // overall tab
  animationDelay = 550 - document.getElementById("slideroverall1").value;
  probRecover = document.getElementById("slideroverall2").value;
  // zone 1
  humanDensityZone1= document.getElementById("slider1a").value;
  BitingRate1= document.getElementById("slider1b").value;
  trapDensityZone1= document.getElementById("slider1c").value;
  TrapRate1= document.getElementById("slider1d").value;
  waterDensityZone1= document.getElementById("slider1e").value;
  SpawnRate1 = document.getElementById("slider1f").value;
  // zone 2
  humanDensityZone2= document.getElementById("slider2a").value;
  BitingRate2= document.getElementById("slider2b").value;
  trapDensityZone2= document.getElementById("slider2c").value;
  TrapRate2= document.getElementById("slider2d").value;
  waterDensityZone2= document.getElementById("slider2e").value;
  SpawnRate2 = document.getElementById("slider2f").value;
  // zone 3
  humanDensityZone3= document.getElementById("slider3a").value;
  BitingRate3= document.getElementById("slider3b").value;
  trapDensityZone3= document.getElementById("slider3c").value;
  TrapRate3= document.getElementById("slider3d").value;
  waterDensityZone3= document.getElementById("slider3e").value;
  SpawnRate3 = document.getElementById("slider3f").value;
  // zone 4
  humanDensityZone4= document.getElementById("slider4a").value;
  BitingRate4= document.getElementById("slider4b").value;
  trapDensityZone4= document.getElementById("slider4c").value;
  TrapRate4= document.getElementById("slider4d").value;
  waterDensityZone4= document.getElementById("slider4e").value;
  SpawnRate4 = document.getElementById("slider4f").value;
  simTimer = window.setInterval(simStep, animationDelay); // call the function simStep every animationDelay milliseconds
  ...
  // zone 1
  persons1 = generatePersons(rowBuildings1,colBuildings1,density=humanDensityZone1);
  zone1Traps = generateTraps(zone1TrapsAvail,trapDensityZone1);
  zone1Waters = generateTraps(zone1WatersAvail,waterDensityZone1);
  // zone 2
  persons2 = generatePersons(rowBuildings2,colBuildings2,density=humanDensityZone2);
  zone2Traps = generateTraps(zone2TrapsAvail,trapDensityZone2);
  zone2Waters = generateTraps(zone2WatersAvail,waterDensityZone2);
  // zone 3
  persons3 = generatePersons(rowBuildings3,colBuildings3,density=humanDensityZone3);
  zone3Traps = generateTraps(zone3TrapsAvail,trapDensityZone3);
  zone3Waters = generateTraps(zone3WatersAvail,waterDensityZone3);
  // zone 4
  persons4 = generatePersons(rowBuildings4,colBuildings4,density=humanDensityZone4);
  zone4Traps = generateTraps(zone4TrapsAvail,trapDensityZone4);
  zone4Waters = generateTraps(zone4WatersAvail,waterDensityZone4);
	// consolidate into a persons list
	persons = [...persons1,...persons2,...persons3,...persons4];
...
function updatePerson(personIndex){
	...
	switch(state){
		case SICK:
			...
			// person recovers from dengue after at most 20 simulation steps
			if (person.timeInfected > 15+Math.random()*5){
